                ...
                <li>
                  <label class="inline-flex items-center relative border-2 rounded-full w-[90px]">
                    ...
                    <svg
                      ...
                      id="Layer_1"
                      xmlns="http://www.w3.org/2000/svg"
                      class="fill-white peer-checked:opacity-60 absolute w-4 h-4 left-[19px]"
                    >
                    ...
                    <svg
                      ...
                      id="Layer_1"
                      xmlns="http://www.w3.org/2000/svg"
                      class="fill-black opacity-60 peer-checked:opacity-70 peer-checked:fill-white absolute w-4 h-4 right-[10px]"
                    >
