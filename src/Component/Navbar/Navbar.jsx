          ...
          <div className="dropdown">
            ...
            {openMenu && (
              ...
              >
                {navList}
                <li>
                  <label class="inline-flex items-center relative border-2 rounded-full w-[90px]">
                    <input
                      checked={isDarkMode}
                    ...
                    <svg
                      ...
                      id="Layer_1"
                      xmlns="http://www.w3.org/2000/svg"
                      class="fill-white peer-checked:opacity-60 absolute w-6 h-4 left-[19px]"
                    >
                    ...
                    <svg
                      ...
                      id="Layer_1"
                      xmlns="http://www.w3.org/2000/svg"
                      class="fill-black opacity-60 peer-checked:opacity-70 peer-checked:fill-white absolute w-4 h-4 right-[12px]"
                    >
        ...
        <div className="navbar-end">
          {user ? (
            ...
            <>
              ...
              <label class=" items-center relative border-2 rounded-full ml-6 hidden md:inline-flex">
                <input
                  checked={isDarkMode}
                  onChange={handleToggle}
                  class="peer hidden"
