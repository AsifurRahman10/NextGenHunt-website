...
export const MyProfile = () => {
  ...
  return (
    <div className="w-full">
      ...
      {/* information */}
      <div className="mt-6 md:mt-10 flex gap-6 flex-col bg-white rounded-lg p-5">
        <div className="flex items-center gap-4">
          ...
          />
          <div>
            <button class="relative hidden group cursor-pointer text-sky-50  overflow-hidden h-10 w-36 rounded-md bg-btnPrimary p-2 flex justify-center items-center font-extrabold">
